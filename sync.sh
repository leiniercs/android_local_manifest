...
sudo mount -t nfs4 -v -o proto=udp,port=9402,nolock,ro 168.235.81.234:/ $CURDIR/roms
#sudo mount -v 100.64.0.1:/ $CURDIR/roms
#sudo mount -v -o proto=udp6,port=9402,ro,nolock [2604:180:f3::421]:/ $CURDIR/roms
