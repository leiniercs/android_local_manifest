...
# Sync the repository
repo sync --jobs=$NCPU --current-branch --no-tags --no-clone-bundle --optimized-fetch --force-sync || repo sync --jobs=$NCPU --current-branch --no-tags --no-clone-bundle --optimized-fetch
